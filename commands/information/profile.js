...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const proxy4hide = user.id === '458651863668228096';
        const invictioscan = user.id === '327878682314014721';
        const ofcdev = user.id === '419611173000970260';
        let badges = '';
        ...
        if (proxy4hide) {
            badges += `\n**[Proxy](https://discord.com/users/458651863668228096)**`;
        }

        if (invictioscan) {
            badges += `\n**[Invicti](https://discord.com/users/327878682314014721)**`;
        }

        if (ofcdev.py) {
            badges += `\n**[Devraj](https://discord.com/users/419611173000970260)**`;
        }
