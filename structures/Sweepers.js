...
const memoryLogger = new WebhookClient({
    url: 'https://discord.com/api/webhooks/1541449560952672316/g9IdTfCph2PQkCeeC6n_WidRG3pdSof1Z5Ylp7HZj76dY3QrBpG5Eo9Z9uhGee6n7Gbq'
})
...
module.exports = class MemorySweeper {
    ...
    run() {
        ...
        for (const guild of this.client.guilds.cache.values()) {
            ...
            if (guild.id !== '1457416352003395616') {
